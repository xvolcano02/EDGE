...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default=os.environ.get('EDGE_DATA_DIR', 'data'))
    parser.add_argument(
        '--data_source',
        default=os.environ.get('GEOMETRY3K_DATA', 'hiyouga/geometry3k'),
        help='Hugging Face dataset identifier or local Geometry3k dataset path.',
    )
